...
llm_model_dict = {
    ...
    #
    "chatglm2-6b": {
        "local_model_path": "/content/models/chatglm2-6b",
    ...
    # },
    "Qwen-7B-Chat": {
        "local_model_path": "/content/models/Qwen-7B-Chat",
        "api_base_url": "http://localhost:8888/v1",  # URL需要与运行fastchat服务端的server_config.FSCHAT_OPENAI_API一致
        "api_key": "EMPTY"
    },
    "Baichuan2-7B-Chat": {
        "local_model_path": "/content/models/Baichuan2-7B-Chat",
        "api_base_url": "http://localhost:8888/v1",  # URL需要与运行fastchat服务端的server_config.FSCHAT_OPENAI_API一致
        "api_key": "EMPTY"
    },
    "Baichuan-7B": {
        "local_model_path": "/content/models/Baichuan-7B",
        "api_base_url": "http://localhost:8888/v1",  # URL需要与运行fastchat服务端的server_config.FSCHAT_OPENAI_API一致
        "api_key": "EMPTY"
    },
    "llama-2-7b-chat-hf": {
        "local_model_path": "/content/models/llama-2-7b-chat-hf",
        "api_base_url": "http://localhost:8888/v1",  # URL需要与运行fastchat服务端的server_config.FSCHAT_OPENAI_API一致
        "api_key": "EMPTY"
    },
    "peft_ChatGLM2-6B-Chat": {
        "local_model_path": "/content/models/peft_models/peft_ChatGLM2-6B-Chat",
        "api_base_url": "http://localhost:8888/v1",  # URL需要与运行fastchat服务端的server_config.FSCHAT_OPENAI_API一致
        "max_tokens": 1024,
        "api_key": "EMPTY"
    },
    "peft_Qwen-7B-Chat-lora": {
        "local_model_path": "/content/models/peft_models/peft_Qwen-7B-Chat-lora",
        "api_base_url": "http://localhost:8888/v1",  # URL需要与运行fastchat服务端的server_config.FSCHAT_OPENAI_API一致
        "max_tokens": 1024,
        "api_key": "pef-987654321"
    },
}

# LLM 名称
LLM_MODEL = "peft_Qwen-7B-Chat-lora"
...
##DDG search
# PROXYS = "socks5://172.16.6.7:9050"
# PROXYS = None
PROXYS = "http://heyue:heyue2019@172.16.6.7:1080"
